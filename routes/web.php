...
Route::middleware('auth:web')->group(function() {
    ...
    // メモ詳細
    Route::get('/memos/detail/{id}', 'MemoController@show')->name('memo.show');
    // メモ追加
    Route::get('/memos/add/', 'MemoController@add')->name('memo.add');
    // メモ登録
    Route::post('/memos/store/', 'MemoController@store')->name('memo.store');
    // メモ編集
    Route::get('/memos/edit/{id}', 'MemoController@edit')->name('memo.edit');
    // メモ更新
    Route::post('/memos/update/{id}', 'MemoController@update')->name('memo.update');
...
Route::middleware('auth:charge')->prefix('charge')->group(function() {
    ...
    // メモ一覧
    Route::get('/memos', 'MemoController@index')->name('charge.memo.index');
    // ユーザー情報
...
// });
// Route::resource('api/charges', 'Api\ChargesController')->only(['index', 'show', 'destroy']);
// Route::get('api/charges', 'Api\ChargesController@index');
// Route::get('api/charges/{id}', 'Api\ChargesController@show');
// Route::delete('api/charges/{id}', 'Api\ChargesController@destroy');
