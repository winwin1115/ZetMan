...
// 営業担当者メモ情報API
Route::resource('charge-remarks', 'Api\ChargeRemarksController')->only(['index', 'show', 'store', 'update', 'destroy']);
...
// 担当者一覧
Route::resource('charges', 'Api\ChargesController')->only(['index', 'show', 'destroy', 'store']);

//member削除
Route::post('deleteMember/{id}', 'Api\ChargesController@deleteMember');
