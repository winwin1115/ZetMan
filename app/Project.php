...
class Project extends Model
{
    ...
    static public function search($params, $user_id)
    {
        ...
        return self::join('orderers', 'orderers.id', '=', 'projects.orderer_id')
    ...
    public function scopeOfStaffId(Builder $query, $key)
    {
        if (blank($key)) return;
        return $query->where('projects.staff_id', $key);
    }
    ...
    {
        return $this->belongsTo('App\Orderer','orderer_id');
    }
