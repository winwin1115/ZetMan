                                ...
                                <div class="content__box__inner">
                                    <div class="content__input">
                                        ...
                                        <div class="input__box">
                                            <input class="bgType" type="text" name="phone" value="{{ old('phone', $projectOrderer->phone) }}" required pattern="\d*"/>
                                        </div>
                                    </div>
                                    <div class="content__input">
                                    ...
                                    <div class="content__input">
                                        ...
                                        <div class="input__wrap">
                                            <div class="input__box">
                                                <input class="bgType" type="tel" name="tel" value="{{ old('tel', $projectOrderer->tel) }}" pattern="\d*"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="content__input">
                                        ...
                                        <div class="input__wrap">
                                            <div class="input__box">
                                                <input class="bgType" type="text" name="fax" value="{{ old('fax', $projectOrderer->fax) }}" pattern="\d*"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="content__input">
