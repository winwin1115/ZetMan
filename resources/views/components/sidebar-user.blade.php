...
<div class="wrap__left">
	<div class="wrap__left__inner">
		...
		<ul>
            ...
            @endif
            @if (!$isCharge)
                <li><a @if ($isCharge) href="{{ route('charge.memo.index') }}" @else href="{{ route('memo.index') }}" @endif>
            ...
            @if (!$isCharge)
                <li><a href="{{ route('charges.index') }}">
                    <img src="{{ asset('assets/img/icon_human_black.png') }}">ユーザー一覧</a></li>
            @endif
            ...
            @endif
            <li class="lineLink">
                <a href="https://line.me/R/share?text=<?= $lineMessate; ?>" target="_blank" rel="noopener noreferrer">カットビのシステムを<br>友達に紹介する</a>
            </li>
