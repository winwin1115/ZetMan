        ...
        <form id="search" @if ($isCharge) action="{{ route('charge.search') }}" @else action="{{ route('search') }}" @endif method="GET">
            ...
            <div class="allWrapper">
                <div class="header__inner flex__wrap f__center">
                    ...
                    <div class="header__right flex__wrap f__end">
                        @if (!$isCharge)
                        <div class="memo f__center">
                            <a href="{{ route('memo.index') }}">
                                <img src="{{ asset('assets/img/icon_memo_black.png') }}">
                            </a>
                        </div>
                        @endif
                        <div class="search f__center commonShadow">
                            <div class="search__inner flex__wrap">
                                <div class="search__text">
                                    <input form="search" type="search" name="keyword" v-model="textbox" placeholder="キーワードを入力">
                                </div>
                            ...
                            <span class="searchToggle" v-on:click="toggleSearch">
                                <img src="{{ asset('assets/img/icon_header_search_black.png') }}">
                            </span>
                        </div>
                    </div>
                </div>
