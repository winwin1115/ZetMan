<div class="wrap__left">
	<div class="wrap__left__inner">
		...
		<ul>
            ...
            <li><a href="{{ route('admin.managers.index') }}"><img src="{{ asset('assets/img/icon_human_black.png') }}">運営者一覧</a></li>
            <li><a href="{{ route('admin.managers.add') }}"><img src="{{ asset('assets/img/icon_people_add_black.png') }}">運営者追加</a></li>
