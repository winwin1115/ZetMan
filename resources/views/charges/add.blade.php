        ...
        <div class="content__wrap">
            ...
            <div class="content__header">
                <div class="content__title">
                    ...
                    <span class="en">User Register</span>
                </div>
            </div>
                    ...
                    <div class="content__box">
                        <div class="content__box__inner">
                            <div class="content__input">
                                <div class="headline attention must">ユーザーの名前</div>
                            ...
                            <div class="content__input">
                                <div class="headline attention must">ユーザー専用のパスワード（8文字以上）</div>
                                <div class="input__wrap">
                                    <div class="input__box">
                            ...
                            <div class="content__input">
                                <div class="headline attention must">ユーザーの電話番号</div>
                                <div class="input__box">
                                    <input class="bgType" type="tel" name="phone" value="{{ old('phone') }}" required pattern="\d*"/>
                                </div>
                            </div>
                            <div class="content__input">
                                <div class="headline attention must">ユーザーに与える権限</div>
                                <div class="input__wrap">
                                ...
                                <p style="margin-top: 2em;">観覧者は一切の編集はできません。編集者のみ可能になります。</p>
                            </div>
                        </div>
                    </div>
                </div>
