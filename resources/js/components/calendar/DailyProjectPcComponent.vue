        ...
        <swiper :options="swiperOption" ref="mySwiper">
            <swiper-slide v-for="(workOnItem, index) in workOnArray" :key="index">
                <div class="content__header">
                    ...
                    <template v-if="isViewer"></template>
                    <template v-else>
                                ...
                                > -->
                                    ...
                                    >
                                        ...
                                        <td>
                                            ...
                                            <span class="company">{{ project.orderer.company }}</span><br>
                                            <template v-if="project.orderer.phone">
                                                <span class="phone">{{ project.orderer.phone }}</span>
                                            </template>
                                            <template v-if="!project.orderer.phone">
                                        ...
                                        <td class="input__box">
                                            <textarea v-model="project.remark" class="bgType remark" ref="remark" @change="modifyRemark(project.id, index_in)"></textarea>
                                        </td>
                                    </tr>
                                <!-- </template> -->
                            </tbody>
