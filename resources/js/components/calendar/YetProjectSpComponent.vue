                ...
                <div class="content__box__inner">
                        ...
                        <div class="common__list__head">
                            ...
                            <div style="display:table; width:100%;">
                                ...
                                <div class="spent_date" style="display:table-cell; text-align:right;">
                                    ...
                                    <span class="colorRed bold">経過日数 {{ Math.ceil((strtotime(new Date()) - strtotime(project.work_on))/3600/24) }}日</span>
                                </div>
                            </div>
                    ...
                    <div class="common__list__body">
                        <ul class="others">
                            ...
                            <li class="company bgCenterCover">{{ project.orderer.company }}</li>
                            <li class="phone bgCenterCover">{{ project.orderer.tel }}</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        props: ['isCharge', 'isViewer', 'urlPrefix', 'listProjects'],
        data() {
            // 必要に応じて変数を定義
            return {
                projects: [],
