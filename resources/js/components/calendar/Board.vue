<template>
	<div class="proccess">
		<Modal :login-id="loginId" :is-charge="isCharge" :user_name="userName" />
				...
				<div class="proccess__print proccess__button">
					<ul class="flex__wrap">
                        <li style="margin-right: 5px;">
                            <a v-if="isCharge != 1" @click.prevent="openDeleteMemberModal">スタッフ削除</a>
                        </li>
                        <li style="margin-right: 5px;">
                            <a v-if="isCharge != 1" @click.prevent="openAddMemberModal">スタッフ追加</a>
		...
		<main class="proccess__main">
			<div class="proccess__wrap">
				<div class="proccess__wrap__inner">
					<div id="process-table" class="process-table">
...
<script>
	...
	export default {
		...
		methods: {
            ...
            openDeleteMemberModal: function() {
