<template>
    <div class="allWrapper input__area">
        ...
        <div class="content__wrap">
            <div class="content__section">
                <div class="content__header">
                    <div class="content__title">
                        <h1 class="h1" v-if="mode === 'undemolition-register'">
                            未解体案件登録
                        </h1>
                        <span class="en" v-if="mode === 'undemolition-register'"
                            >Undisassembled Register</span
                        >
                        <h1 class="h1" v-if="mode === 'register'">
                            新規架設登録
                        </h1>
                        <span class="en" v-if="mode === 'register'"
                            >New Register</span
                        >
                        <h1 class="h1" v-if="mode === 'edit'">案件編集</h1>
                        <span class="en" v-if="mode === 'edit'"
                            >Project Edit</span
                        >
                        <h1 class="h1" v-if="mode === 'advance_notice'">
                            前日連絡
                        </h1>
                        <span class="en" v-if="mode === 'advance_notice'"
                            >Advance Notice</span
                        >
                    </div>
                </div>
                        ...
                        <div class="content__box">
                            <div class="content__box__inner">
                                ...
                                <div class="content__input">
                                    <div class="headline attention any">
                                        作業員
                                    </div>
                                    <div class="input__wrap">
                                        <div class="input__box selectBox">
                                ...
                                <div class="content__input">
                                    ...
                                    <template v-for="(item, index) in work_on_array">
                                        <div v-if="mode !== 'advance_notice'" class="input__wrap delete__wrap flex__wrap f__start v__center">
                                            ...
                                            <div class="input__box calender">
                                                <span @click="doOpen(index)"
                                                    ><img
                                                        src="/assets/img/icon_calender_black.png"
                                                /></span>
                                            </div>
                                            <div
                                                class="input__delete"
                                                @click="deleteWorkOn(index)"
                                            >
                                                <span
                                                    ><img
                                                        src="/assets/img/icon_minus_white.png"
                                                /></span>
                                            </div>
                                            <vuejs-datepicker
                                                :language="ja"
                                        ...
                                        >
                                            ...
                                            <div class="input__box twoInput">
                                                <select
                                                    class="bgType"
                                                    v-model="
                                                        item.scheduled_arrival_time_from
                                                    "
                                                    @change="changeTimeTo"
                                                >
                                                    <template
                                                        v-for="hour in fromHourArray"
                                                    >
                                                        <template
                                                            v-for="minute in minuteArray"
                                                        >
                                                            <option
                                                                :value="
                                                                    `${hour}:${minute}`
                                            ...
                                            <div class="input__box twoInput">
                                                <select
                                                    class="bgType"
                                                    v-model="
                                                        item.scheduled_arrival_time_to
                                                    "
                                                >
                                                    <template
                                                        v-for="hour in toHourArray"
                                                    >
                                                        <template
                                                            v-for="minute in minuteArray"
                                                        >
                                    ...
                                    <div
                                        class="content__add flex__wrap f__center"
                                        v-if="mode !== 'advance_notice'"
                                    >
                                        <button @click="addWorkOn">
                                            施工予定日を追加
                                            <span class="f__center"
                                                ><img
                                                    src="/assets/img/icon_add_white_bold.png"
                                            /></span>
                                        </button>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div
                                        class="input__wrap flex__wrap f__start v__center"
                                    >
                                ...
                                >
                                    ...
                                    <div
                                        class="input__wrap flex__wrap v__center"
                                    >
                                        ...
                                        <ul class="flex__wrap selectColor">
                                            <li class="colorBox one">
                                                <input
                                                    ...
                                                    ref="color1"
                                                    v-model="
                                                        project.project_color_id
                                                    "
                                                    value="1"
                                                    name="colorGroup"
                                                    @click="radioDeselection(1)"
                                                /><label></label>
                                            </li>
                                            <li class="colorBox two">
                                                <input
                                                    type="radio"
                                                    ref="color2"
                                                    v-model="
                                                    ...
                                                    value="2"
                                                    name="colorGroup"
                                                    @click="radioDeselection(2)"
                                                /><label></label>
                                            </li>
                                            <li class="colorBox three">
                                                <input
                                                    type="radio"
                                                    ref="color3"
                                                    v-model="
                                                    ...
                                                    value="3"
                                                    name="colorGroup"
                                                    @click="radioDeselection(3)"
                                                /><label></label>
                                            </li>
                                            <li class="colorBox four">
                                                <input
                                                    type="radio"
                                                    ref="color4"
                                                    v-model="
                                                    ...
                                                    value="4"
                                                    name="colorGroup"
                                                    @click="radioDeselection(4)"
                                                /><label></label>
                                            </li>
                                            <li class="colorBox five">
                                                <input
                                                    type="radio"
                                                    ref="color5"
                                                    v-model="
                                                    ...
                                                    value="5"
                                                    name="colorGroup"
                                                    @click="radioDeselection(5)"
                                                /><label></label>
                                            </li>
                                            <li class="colorBox six">
                                                <input
                                                    type="radio"
                                                    ref="color6"
                                                    v-model="
                                                    ...
                                                    value="6"
                                                    name="colorGroup"
                                                    @click="radioDeselection(6)"
                                                /><label></label>
                                            </li>
                                            <li class="colorBox seven">
                                                <input
                                                    type="radio"
                                                    ref="color7"
                                                    v-model="
                                                    ...
                                                    value="7"
                                                    name="colorGroup"
                                                    @click="radioDeselection(7)"
                                                /><label></label>
                                            </li>
                                            <li class="colorBox eight">
                                                <input
                                                    type="radio"
                                                    ref="color8"
                                                    v-model="
                                                    ...
                                                    value="8"
                                                    name="colorGroup"
                                                    @click="radioDeselection(8)"
                                                /><label></label>
                                            </li>
                                            <li class="colorBox nine">
                                                <input
                                                    type="radio"
                                                    ref="color9"
                                                    v-model="
                                                    ...
                                                    value="9"
                                                    name="colorGroup"
                                                    @click="radioDeselection(9)"
                                                /><label></label>
                                            </li>
                                            <li class="colorBox ten">
                                                <input
                                                    type="radio"
                                                    ref="color10"
                                                    v-model="
            ...
            <div
                class="content__wrap detail__construction"
                v-if="mode !== 'advance_notice'"
                        ...
                        <div class="content__box">
                            <div class="content__box__inner">
                                <div class="content__input">
                                    ...
                                    <div class="input__wrap">
                                        <div
                                            class="input__box selectBox"
                                            :class="{
                                                nonInput: is_new_project_orderer
                                            }"
                                            :disabled="is_new_project_orderer"
                                            :required="!is_new_project_orderer"
                                        >
                                            <select
                                                class="bgType"
                                                v-model="project_orderer_id"
                                            >
                                    ...
                                    >
                                        <button
                                            @click="
                                                is_new_project_orderer = !is_new_project_orderer
                                            "
                                        >
                                            新規の元請け情報を登録
                                            <span class="f__center"
                                    ...
                                    <div
                                        class="input__add"
                                        v-if="is_new_project_orderer"
                                    >
                                        <div class="content__input">
                                            <div
                                                class="headline attention must"
                                            >
                                                会社名
                                            </div>
                                            <div class="input__box">
            ...
            <div class="content__submit f__center">
                <div class="submit__box">
                    ...
                    <button
                        type="button"
                        @click.prevent="registerUndemolitionProject"
                        v-if="mode === 'undemolition-register'"
                    >
                        案件登録
                    </button>
                    <button
                    ...
                    <button
                        type="button"
                        @click.prevent="confirmAdvanceNotice"
                        v-if="mode === 'advance_notice'"
                    >
                        前日連絡
                    </button>
...
export default {
    ...
    created: function() {
        ...
        console.log(this.mode, "HHHH");
        console.log(this.user_id, "USER_ID");
        console.log(this.isCharge, "isCharge");

        // 編集画面or前日連絡画面or未解体案件登録画面である場合、案件詳細取得APIを呼び出す
        if (
            this.mode === "edit" ||
            this.mode === "advance_notice" ||
            this.mode === "undemolition-register"
        ) {
            // 案件情報を取得
            axios
                ...
                .then(result => {
                    ...
                    console.log("isCharge:", this.isCharge);
                    console.log("login_id:", this.login_id);
                    console.log("charge_id:", this.project.charge_id);
                    ...
                    this.project_orderer_id = result.data.orderer.id;
                    this.project.is_send_to_user = result.data.is_send_to_user;
                    this.project.is_send_to_charge =
                        result.data.is_send_to_charge;
                    this.project.project_color_id =
                        result.data.project_color_id ?? "";
                    if (
                        this.mode === "edit" ||
                        this.mode === "advance_notice" ||
                        this.mode === "undemolition-register"
                        ...
                        this.work_on_array = [];
                        const dateDataSplit = result.data.work_on_date.split("-");
                        const dateData = {
                            id: result.data.id,
                            ...
                            scheduled_arrival_time_from:
                                result.data.scheduled_arrival_time_from ??
                                "08:00",
                            scheduled_arrival_time_to:
                                result.data.scheduled_arrival_time_to ??
                                "08:30"
                        };
            ...
            .then(result => {
                ...
                if (this.mode === "register" && this.charges.length > 0) {
                    if (this.isCharge == 1) {
                        ...
                        var selectedCharge = this.charges.filter(item => {
                            return item.user_id == this.user_id;
                        })[0];
                        if(selectedCharge) this.project.charge_id = selectedCharge.id;
                        this.project.worker_id = 0;
                    }
                }
            })
        ...
        // 元請け情報を取得
        axios
            .get("/api/project-orderers", {})
            .then(result => {
                this.project_orderers = result.data;
                if (
                    this.mode === "register" &&
                    this.project_orderers.length > 0
                ) {
    ...
    methods: {
        ...
        registerProject: function() {
            ...
            axios
                ...
                .then(result => {
                    ...
                    // 登録後、現場_詳細の画面へ遷移
                    location.href =
                        this.urlPrefix + "/projects/detail/" + result.id;
                })
                .catch(result => {
        ...
        registerUndemolitionProject: function() {
            const params = this.setParams();
            axios
                .post("/api/undemolition-projects/" + this.id, params)
                .then(result => {
                    alert("未解体案件を更新しました。");
                    // 登録後、現場_詳細の画面へ遷移
                    location.href =
        ...
        updateProject: function() {
            const params = this.setParams();
            axios
                .post("/api/projects/erection/" + this.id, params)
                .then(result => {
                    alert("案件を更新しました。");
        ...
        advanceNotice: function() {
            const params = this.setParams();
            axios
                .post("/api/projects/advance-notice/" + this.id, params)
                .then(result => {
                    // API呼出し後、案件_前日連絡_完了画面へ遷移
                    location.href =
                        this.urlPrefix +
                        "/projects/advance-notice/" +
                        this.id +
                        "/sent";
                })
                .catch(result => {
        ...
        deleteWorkOn: function(index) {
            ...
            this.pickedDate.splice(index, 1);
        },
        ...
        selected: function(index) {
            ...
            setTimeout(function() {
                obj.work_on_array[index].year = obj.pickedDate[
                    index
                ].getFullYear();
                obj.work_on_array[index].month = obj.zeroPadding(
                    obj.pickedDate[index].getMonth() + 1,
                    2
                );
                obj.work_on_array[index].day = obj.zeroPadding(
                    obj.pickedDate[index].getDate(),
                    2
                );
            }, 100);
        },
        ...
        changeTimeTo: function() {
            ...
            // 時間を取得
            const hour = Number(
                this.work_on_array[0].scheduled_arrival_time_from.slice(0, 2)
            );
            // 分を取得
            const minute = Number(
                this.work_on_array[0].scheduled_arrival_time_from.slice(-2)
            );
            let arraival_hour = "";
            let arraival_minute = "";
            // 到着時間によって到着時間予想の条件分岐
