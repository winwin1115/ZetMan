            ...
            <div class="content__section">
                ...
                <div class="content__header">
                    <div class="content__title">
                        <h1 class="h1">ユーザー情報詳細</h1>
                        <span class="en">User Details</span>
                    </div>
                        ...
                        <div class="content__box">
                            <div class="content__box__inner">
                                <div class="content__input">
                                    <div class="headline">ユーザーの名前</div>
                                    <div class="input__text">
                                        <span v-if="charge">{{ charge.name }}</span>
                                    </div>
                                </div>
                                <div class="content__input">
                                    <div class="headline">ユーザーの電話番号</div>
                                    <div class="input__text">
                                        <span v-if="charge">{{ charge.phone }}</span>
                                    </div>
                                </div>
                                <div class="content__input">
                                    <div class="headline">ユーザーに与える権限</div>
                                    <div class="input__text">
                                        <span v-if="charge">
        ...
        methods: {
            ...
            confirm: function() {
                if (this.charge.has_project) {
                    this.message = '案件に紐づいている為、ユーザー情報を削除できません。'
                    this.mode    = ''
                } else {
                    this.message = 'ユーザー情報を削除します。よろしいでしょうか？'
                    this.mode    = 'delete'
                }
