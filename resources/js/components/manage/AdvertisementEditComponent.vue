                        ...
                        <div class="content__box">
                            <div class="content__box__inner">
                                ...
                                <div class="content__input">
                                    ...
                                    <div class="input__box">
                                        <input class="bgType" type="tel" name="" v-model="advertisement.tel" oninput="value = value.replace(/[０-９]/g,s => String.fromCharCode(s.charCodeAt(0) - 65248)).replace(/\D/g,'');">
                                    </div>
                                </div>
                                <div class="content__input">
                                ...
                                <div class="content__input">
                                    ...
                                    <div class="input__box">
                                        <input class="bgType" type="tel" name="" v-model="advertisement.phone" oninput="value = value.replace(/[０-９]/g,s => String.fromCharCode(s.charCodeAt(0) - 65248)).replace(/\D/g,'');">
                                    </div>
                                </div>
                                <div class="content__input">
                                    ...
                                    <div class="input__wrap flex__wrap f__start v__center">
                                        <div class="input__box post__one">
                                            <input class="bgType" type="text" name="" placeholder="000" v-model="zip_first" oninput="value = value.replace(/[０-９]/g,s => String.fromCharCode(s.charCodeAt(0) - 65248)).replace(/\D/g,'');">
                                        </div>
                                        -
                                        <div class="input__box post__two">
                                            <input class="bgType" type="text" name="" placeholder="0000" v-model="zip_second" oninput="value = value.replace(/[０-９]/g,s => String.fromCharCode(s.charCodeAt(0) - 65248)).replace(/\D/g,'');">
                                        </div>
                                    </div>
                                </div>
                                <div class="content__input">
