...
// メモ詳細
Vue.component('memo-show-component', require('./components/memos/MemoShowComponent.vue').default);
...
// モジュール
Vue.component('datepicker-module', require('./components/modules/Datepicker.vue').default);
